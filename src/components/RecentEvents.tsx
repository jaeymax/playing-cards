...
const RecentEvents = () => {
  ...
  return (
    <Card className="w-full max-w-md bottom-nav border-gray-600/20 shadow-md text-white">
      <CardContent className="p-6">
        ...
        <div className="space-y-4">
          {events.map((event, index) => (
            <div
              key={event.id}
              className="flex items-center space-x-4 p-3 rounded-lg header hover:bg-gray-700 transition-all duration-200 transform hover:scale-102"
              style={{
