...
interface GameForfeitedPageProps {
  gameCode?: string;
  forfeitedBy?: string;
  winner?: string;
  onReturnHome?: () => void;
...
const GameForfeitedPage = ({
  gameCode,
  forfeitedBy,
  winner,
  onReturnHome,
  onGoBack,
}: GameForfeitedPageProps) => {
  ...
  return (
    <div className="relative bg-green-800 bg-[url('https://res.cloudinary.com/dbvame158/image/upload/v1770519565/background1_jx3rry.jpg')] bg-cover min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-20 right-10 w-72 h-72 bg-red-500/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 max-w-md w-full">
        <div className="bg-slate-900/40 backdrop-blur-md rounded-2xl p-8 lg:p-12 border border-blue-400/20 shadow-2xl text-center">
          ...
          <div className="mb-6 flex justify-center">
            <div className="p-4 bg-orange-500/20 border border-orange-400/50 rounded-full backdrop-blur-sm">
              <svg
          ...
          {forfeitedBy && (
            <div className="mb-8">
              <p className="text-gray-300 mb-2">
                ...
                <span className="text-gray-400"> forfeited the match.</span>
              </p>
              {winner && (
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-4 mb-8 border border-gray-700/30">
            ...
            <ul className="text-left space-y-2 text-sm text-gray-300">
              ...
              <li className="flex items-center justify-between">
                ...
                <span className="text-orange-400 font-semibold">Forfeited</span>
              </li>
              <li className="flex items-center justify-between">
...
export default GameForfeitedPage;
