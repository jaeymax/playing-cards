          ...
          <div className="lg:col-span-2">
            {status === 'success' ? (
              <div className="bg-gray-800 rounded-lg border border-gray-700 p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Support Ticket Submitted</h3>
                      ...
                      <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-400">
                          <label className="relative cursor-pointer rounded-md font-medium text-blue-400 hover:text-blue-300 focus-within:outline-none">
                            ...
                            <input type="file" className="sr-only" multiple onChange={e => setFormData({...formData, attachments: Array.from(e.target.files || [])})} />
                          </label>
            ...
            <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-300">support@nexuscards.com</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
