        ...
        <div className="p-3">
           <div className="flex gap-3 borde" >
              <div className="flex-1 flex items-center justify-end message-input px-4 relative rounded-md  min-w-0" >
                 <input type="text" className="flex-1 text-xs absolute px-4 left-0 right-0 top-0 bottom-0 rounded-md placeholder:text-xs placeholder:font-bold focus:ring-1 focus:ring-green-400 bg-transparent min-w-0 outline-none" placeholder="Your message..." />
