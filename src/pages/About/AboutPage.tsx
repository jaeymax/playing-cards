  ...
  const features = [
    {
      ...
      description: "Challenge players worldwide in real-time card battles",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Participate in daily and weekly tournaments with prize pools",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description: "Fair matchmaking system based on player skill and rating",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
        ...
        <div className="container mx-auto px-4 py-16 lg:py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              ...
              innovative platform designed for competitive players.
            </p>
          </div>
        </div>
        <div className="absolute bottom-0 inset-x-0 h-40 bg-gradient-to-t from-gray-900"></div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-gray-800 rounded-lg p-6 border border-gray-700 transform transition hover:scale-[1.02]"
            >
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg mb-8">
            To create the most engaging and competitive online card gaming
